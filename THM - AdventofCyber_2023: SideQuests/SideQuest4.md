...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/95a94bb0-2d32-40a8-83f2-82d1b3447de3)

On port 8000 we get a very cute looking website from which we can download images:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/d26846b7-2b5b-41bf-b39f-962c4de27862)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/9b0c0432-6b35-4784-bceb-7f877a659274)

We see that the /console is accessible so Debug is enabled:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/005e964b-ca51-4bfe-a76d-1c45fc9d3859)

Including a single quote in the id parameter outputs a MySQL error which indicates the possibility of some SQL injection:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/d651479b-f197-4fac-820f-2be355d7e49b)

Because Debug is on and the error output is verbose, we can also see the location where the application is running from:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/6d86c149-a6c2-4ca3-a656-2bfb6ddb4e58)

Dumping the database with SQLMap doesn't yield anything useful:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/5029a8cb-5d0d-4720-b5ae-01bfd6d1c36f)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/ccb6f155-2b09-4e7f-aa2e-75f1cb2b5ab6)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/13c6849e-b5e2-439a-8978-604492500a93)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/faaf3dd2-92df-4437-afd2-76b7a4262810)

![image](https://github.com/LazyTitan33/myCreations/assets/80063008/803694dc-ee34-4612-bf41-cfc987c056a4)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/236794e5-e776-4f1c-b699-d64e3d0a2b60)

Enumerating the git commits, we find a password in one of them which works for our user:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/753e0caf-728d-42f5-8562-f27b0ee64f8e)

`F453TgvhALjZ`

Checking the sudo privileges now that we have the password, we find that the user can run a specific bash script as root:  
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/b5c68fb3-827a-4c69-a4dd-4df60adae238)
...
![image](https://github.com/LazyTitan33/myCreations/assets/80063008/1cd68f60-76c2-4536-9be2-bed3983ecd40)
